...
class GameScore < ActiveRecord::Base
  DIRTY_WORDS = Set.new(%w(666 $3X $EX A$$ A$5 A$S A$S A5$ A55 AS$ ASS BCH BUM BUT CNT COK C0K CUM D!3 D!E D1E D1E DCK DIE DIK F@G F@T F4G F4T FAG FAT FCK FKK FUC FUK FUX G@Y G0D G4Y GAY GOD GUN IRA J!Z J1Z JIZ KKK KNT KOK LIK LSD NIG P00 P33 P5Y PEE POO POT PSY S3X SEX SHT SUK T!T TIT VAG VAJ).freeze)
