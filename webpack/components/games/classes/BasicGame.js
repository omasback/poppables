...
export default class extends Phaser.Game {
  ...
  stop() {
    ...
    iframe.src = 'https://1358061.fls.doubleclick.net/activityi;src=1358061;type=2017l00;cat=2017l006;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;ord=' + Math.random() * 10000000000000 + '?';
    iframe.width = '1';
    iframe.height = '1';
